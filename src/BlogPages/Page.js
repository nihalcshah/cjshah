...
const Page = ({title, topColor, bottomColor, textColor, details}) => {
    return (
        <div className="instrument" id="Projects">
            <div className={`fixed h-screen w-screen bg-gradient-to-br bg-fixed overflow-hidden ${topColor} ${bottomColor}`}>
	...
	s371.981,38.998,575.971,0s293.985-39.278,505.474,5.859s493.475,48.368,716.963-4.995v560.106H-363.852V502.589z" />
            ...
            <div className="relative w-4/6 pt-10  mx-auto">
                <div className={`text-${textColor} pt-10`}>
                    <h1 style={{}} className="text-5xl font-bold mb-5"> {title} </h1>
                    <div className="flex p-2">
                        <img src="/personalshots/cj.jpg" className="rounded-full w-8" />
                        <h1 className="my-auto ml-3 text-xl font-bold">Nihal CJ Shah</h1>
                    </div>
                </div>
                <br />
                <div className={` mx-auto text-${textColor}`} id="" >
                    {details}
                </div>
            </div>
